...
void test3() {
	...
	operand_fields[0] = "foo";
	instruction_t instruction = {mnemonic, operand_fields};
	int foo_address = 0x14;
	int current_address = 0xc; // Instruction is at 0x18, offset due to pipeline.
